...
export declare namespace MyToken {
  export type TokenDataStruct = { id: BigNumberish; uri: string };

  export type TokenDataStructOutput = [id: bigint, uri: string] & {
    id: bigint;
    uri: string;
  };
}
...
export interface MyTokenInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "getAllTokenURIs",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "getAllTokensOfOwner",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export interface MyToken extends BaseContract {
  ...
  getAllTOkens: TypedContractMethod<
    [],
    [MyToken.TokenDataStructOutput[]],
    "view"
  >;

  getAllTokenURIs: TypedContractMethod<[], [string[]], "view">;

  getAllTokensOfOwner: TypedContractMethod<
    [owner: AddressLike],
    [MyToken.TokenDataStructOutput[]],
    "view"
  >;
  ...
  ): TypedContractMethod<[], [MyToken.TokenDataStructOutput[]], "view">;
  getFunction(
    nameOrSignature: "getAllTokenURIs"
  ): TypedContractMethod<[], [string[]], "view">;
  getFunction(
    nameOrSignature: "getAllTokensOfOwner"
  ): TypedContractMethod<
    [owner: AddressLike],
    [MyToken.TokenDataStructOutput[]],
    "view"
